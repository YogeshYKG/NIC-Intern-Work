...
<head>
  ...
  <link href="js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
    ...
    <style type="text/css">
    body{
      background: url(pizzabox.jpg) no-repeat center center;background-size: cover;
      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php " enctype="multipart/form-data" novalidate="novalidate" class="col s12">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <label for="fies" class="center-align" id="tt7">Choose Image</label>
            <input name="fies" id="img" type="file" value="ProfileImage">
            </div>
        </div>
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-action-lock-outline prefix" id="tt8"></i>
            <input name="password" id="password" type="password" data-error=".errorTxt3">
            <label for="password" id="tt8">Password</label>
